...
export const Icons = {
  ...
  Export: ({ className = "w-5 h-5", style }: IconProps) => <svg viewBox="0 0 24 24" fill="currentColor" className={className} style={style}><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" /></svg>,
  Import: ({ className = "w-5 h-5", style }: IconProps) => <svg viewBox="0 0 24 24" fill="currentColor" className={className} style={style}><path d="M9 16h6v-6h4l-7-7-7 7h4v6zm-4 2v2h14v-2H5z" /></svg>,
